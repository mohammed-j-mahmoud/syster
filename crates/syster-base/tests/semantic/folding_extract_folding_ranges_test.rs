...
fn test_kerml_import_and_annotation_ignored() {
    ...
    let file = KerMLFile {
        namespace: None,
        elements: vec![
            KerMLElement::Import(syster::syntax::kerml::ast::Import {
                path: "Some::Path".to_string(),
                is_recursive: false,
                kind: syster::syntax::kerml::ast::ImportKind::Normal,
                span: Some(make_span(1, 1)),
            }),
            KerMLElement::Annotation(syster::syntax::kerml::ast::Annotation {
...
fn test_sysml_import_and_alias_ignored() {
    ...
    let file = SysMLFile {
        ...
        namespaces: vec![],
        elements: vec![
            SysMLElement::Import(syster::syntax::sysml::ast::Import {
                path: "Some::Path".to_string(),
                is_recursive: false,
                span: Some(make_span(1, 1)),
            }),
            SysMLElement::Alias(syster::syntax::sysml::ast::Alias {
